...
public class Orcamento extends JDialog {
	...
	public Orcamento(Menu menu) {
		super(menu, "Loja de Carros", true);
		setResizable(false);
		...
		btCancelar.addActionListener(new ActionListener() {
    		...
    		JCheckBox[] ckOpcionais = {ckRodasAluminio, ckBancoCouro, ckbancoConcha, ckfibraCarbono};
      			...
      			txCelular.setText("");
      	        rdPreto.setSelected(true);
      			for ( JCheckBox opcional : ckOpcionais ) {
		...
		lbCarName.setBounds(400, 20, 560, 40);
		lbCarName.setFont(interBold);
		lbCarName.setHorizontalAlignment(JLabel.RIGHT);
		add(lbCarName);
		
		car = new JLabel();
		car.setBounds(500, 100, 500, 250);
		add(car);
